              ...
              {gameStatistics?.map((stat) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm text-gray-600">
                    ...
                    <p>
                      Total Wagered: ₹{Number(stat.total_wagered).toFixed(2)}
                    </p>
                    ...
                    <p>
                      Last Played: {new Date(stat.last_played).toLocaleString()}
                    </p>
                  </div>
                </div>
              ))}
              ...
              {transactions.map((tx) => (
                ...
                >
                  <div className="flex items-center">
                    {tx.game_icon && (
                      <span className="text-xl mr-2">{tx.game_icon}</span>
                    )}
                    <div>
                      <p className="text-sm font-medium text-gray-900 flex items-center">
                        ...
                        {tx.type === "game_loss" && (
                          <PlayCircle className="h-5 w-5 text-red-600 mr-1" />
                        )}
                        {tx.type === "deposit" && (
